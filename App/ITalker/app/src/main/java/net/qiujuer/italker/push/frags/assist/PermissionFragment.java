...
public class PermissionFragment extends BottomSheetDialogFragment
    ...
    private void refreshState(View root) {
        ...
        root.findViewById(R.id.im_status_permission_network)
                .setVisibility(haveNetworkPerm(context) ? View.VISIBLE : View.GONE);

        root.findViewById(R.id.im_status_permission_read)
                .setVisibility(haveReadPerm(context) ? View.VISIBLE : View.GONE);

        root.findViewById(R.id.im_status_permission_write)
                .setVisibility(haveWritePerm(context) ? View.VISIBLE : View.GONE);

        root.findViewById(R.id.im_status_permission_record_audio)
    ...
    private static void show(FragmentManager manager) {
        // 去重避免多次界面重复可见导致弹出框累积
        String tag = PermissionFragment.class.getName();
